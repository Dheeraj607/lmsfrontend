...
//   const transaction_id = typeof window !== "undefined"
...
//       try {
//         const response = await fetch(`http://localhost:5000/payment-requests/order/${transaction_id}`);
//         if (!response.ok) throw new Error("Failed to fetch order details.");
//         const data: Order = await response.json();
...
//     const options: any = {
//       key: process.env.NEXT_PUBLIC_RAZORPAY_KEY_ID||"rzp_test_bgUFcUzfDPatTa",
